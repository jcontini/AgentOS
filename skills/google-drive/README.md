...
Use the Python script: `skills/google-drive/drive.py`
...
python3 "$PROJECT_ROOT/skills/google-drive/drive.py" --user user@example.com list

# List files in a specific folder
python3 "$PROJECT_ROOT/skills/google-drive/drive.py" --user user@example.com list --folder-id "FOLDER_ID"

# List more results
python3 "$PROJECT_ROOT/skills/google-drive/drive.py" --user user@example.com list --max-results 50
```
...
```bash
# Search by name
python3 "$PROJECT_ROOT/skills/google-drive/drive.py" --user user@example.com search --query "meeting notes"

# Search for specific file type
python3 "$PROJECT_ROOT/skills/google-drive/drive.py" --user user@example.com search --query "budget" --type doc
python3 "$PROJECT_ROOT/skills/google-drive/drive.py" --user user@example.com search --query "report" --type sheet
python3 "$PROJECT_ROOT/skills/google-drive/drive.py" --user user@example.com search --query "project" --type folder
```
...
```bash
python3 "$PROJECT_ROOT/skills/google-drive/drive.py" --user user@example.com metadata --file-id "FILE_ID"
```
...
python3 "$PROJECT_ROOT/skills/google-drive/drive.py" --user user@example.com read --file-id "FILE_ID"

# Read first 5000 characters
python3 "$PROJECT_ROOT/skills/google-drive/drive.py" --user user@example.com read --file-id "FILE_ID" --max-chars 5000

# Read with offset (for pagination)
python3 "$PROJECT_ROOT/skills/google-drive/drive.py" --user user@example.com read --file-id "FILE_ID" --max-chars 5000 --offset 5000
```
...
python3 "$PROJECT_ROOT/skills/google-drive/drive.py" --user user@example.com read-doc --file-id "DOC_ID" --max-chars 5000

# Read starting from character 10000
python3 "$PROJECT_ROOT/skills/google-drive/drive.py" --user user@example.com read-doc --file-id "DOC_ID" --max-chars 5000 --start 10000
```
